...
// Route::get('dashboard/ether1 - ISPJawara Lintas Data Nusantara', [DashboardController::class, 'traffic'])->name('dashboard.traffic-isp1');

// Pembayaran
Route::get('pppoe/pembayaran', [PPPoEController::class, 'payment_management'])->name('pppoe.payment_management');
Route::post('pppoe/pembayaran/set-lunas/{id}', [PPPoEController::class, 'set_lunas'])->name('pppoe.set_lunas');
